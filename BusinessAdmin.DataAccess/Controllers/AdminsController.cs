...
namespace BusinessAdmin.DataAccess.Controllers
{
    ...
    public class AdminsController : ControllerBase
    {
        ...
        //GET: api/Admins/5
        [HttpGet("{id}")]
        public async Task<ActionResult<AdminDTO>> GetAdmin(int id,string passwd)
        {
            if (_context.Admin == null)
            {
                return NotFound();
            ...
            var adminPasswd = admin.Passwd;
            var adminId = admin.AdminId;

            var adminDTO = new AdminDTO(adminId == id,adminPasswd == passwd);
